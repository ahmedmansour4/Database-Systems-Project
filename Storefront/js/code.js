...
function doSignUp() {
	...
	var jsonPayload = '{ "email" : "' + email + '", "userName" : "' + userName + '" , "passWord" : "' + passWord + '" , "firstName" : "' + firstName + '" , "lastName" : "' + lastName + '" , "phone" : "' + phone + '" , "address" : "' + address + '" , "adminFlag" : "' + 0 + '" }';
	var url = urlBase + 'Storefront/api/SignUp.' + extension;
	...
	try {
		...
		console.log(jsonObject.Mess + "test!");
