<?php
	...
	$policyPercent = $inData["percent"];
	
	$policyMin = $inData["minPeople"];

	$policyMax = $inData["maxPeople"];
...

    {
        ...
        $checkStatus = "SELECT DiscountCategoryId FROM DiscountCategory WHERE DiscountCategoryId='".$policyID."'";
...

        {
            ...
            $sql = "INSERT INTO DiscountCategory (DiscountCategoryId, MinPeople, MaxPeople, DiscountPercent) VALUES ('$policyID', '$policyMin', '$policyMax', '$policyPercent')";
