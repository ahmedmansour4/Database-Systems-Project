<?php
...

    {
        ...
        $checkStatus = "SELECT ".$type." FROM Product WHERE ".$type."='".$product."'";
...

        {
            ...
            returnWithError( "That product is not available" );
...

        {
            ...
            $sql = "DELETE FROM Product WHERE ".$type."='".$product."'";
